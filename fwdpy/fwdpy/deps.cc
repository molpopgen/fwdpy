...
namespace fwdpy
{
  ...
  annote =   {doi:/10.1534/genetics.114.165019}
    ...
    fwdpy_citation()
    {
        std::cout << "If you use fwdpy for your research, please cite the "
                     "following:\n"
                  << "You are using fwdpy version " << PACKAGE_VERSION << '\n'
                  << "You should also cite the fwdpp paper, which is the "
                     "brains behind this package\n"
                  << "You can get the fwdpp version used with the terminal "
                     "command fwdpp-config --version\n"
