from fwdpy.fitness cimport singlepopFitness,genotype_fitness_updater,fitness_function_finalizer,make_custom_fitness
...
cdef double additive_finalize_testing(const double w):
    return 1.0 + w
...
cdef class additiveFitnessTesting(singlepopFitness):
    def __cinit__(self):
        self.wfxn = make_custom_fitness(<genotype_fitness_updater>additive_het_testing,
                                        ...
                                        <fitness_function_finalizer>additive_finalize_testing,
                                        0.0)
